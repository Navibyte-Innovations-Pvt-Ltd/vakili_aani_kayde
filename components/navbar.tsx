...
const NAVBAR_LABELS: Record<Language, NavbarLabels> = {
  ...
  HINDI: { brandName: "वकालत और कायदे", home: "मुख्यपृष्ठ", ebooks: "ई-बुक्स", combos: "कॉम्बो पैक", buyNow: "अभी खरीदें", myBooks: "मेरी किताबें", myBooksSub: "अपनी खरीद डाउनलोड करें", buyEbooks: "ई-बुक्स खरीदें", buyEbooksSub: "केवल ₹49 से", callUs: "कॉल करें", whatsapp: "व्हाट्सएप", legalPlatform: "कानूनी मंच", authorityTag: "आधिकारिक कानूनी मंच" },
